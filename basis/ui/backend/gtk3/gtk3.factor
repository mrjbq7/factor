...
environment gdk3.ffi glib.ffi
gobject.ffi gtk3.ffi io.encodings.binary
...
ui.backend ui.backend.x11.keys
...
: detect-scale-factor ( -- n )
    "GDK_SCALE" os-env [
        ...
        ! GTK3 has better scale factor support
        gdk_screen_get_default
        [ gdk_screen_get_resolution 96.0 / ]
        [ gdk_screen_get_primary_monitor gdk_monitor_get_scale_factor ]
        bi max
    ] if* 1.0 max ;
